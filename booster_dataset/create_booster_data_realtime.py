...
import queue
import logging
from utils.compute_fk import ArmKinematicsSolver
class DataCollector:
    def __init__(self, data_type="train", save_dir="data", episode_length=100):
        urdf_path = "./utils/T1_7_dof_arm_serial_with_head_arm.urdf"
    ...
    def stop(self):    
        ...
        if self.current_episode:
            ...
            self._record_single_episode(self.episode_count, self.current_episode)
