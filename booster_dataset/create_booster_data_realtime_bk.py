...
class DataCollector:
    def __init__(self, data_type="train", save_dir="data", episode_length=100):
        ...
        # # 使用线程池进行保存操作
        # self.save_executor = ThreadPoolExecutor(max_workers=2)  # 使用2个线程进行保存
        # self.save_futures = []
    ...
    def save_episode(self):
        ...
        for i, episode in enumerate(self.episodes):
            ...
            np.save(filepath, np.array(episode))
...
def main():
    ...
    data_collector = DataCollector(data_type="train", save_dir="data", episode_length=30 * 120)
